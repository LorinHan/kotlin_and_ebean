...
```
### 6. 打开Idea设置 settings中的plugins，查找ebean 11，添加Ebean 11 Enhancement，然后重启Idea，在菜单栏的Build中可以看到Ebean 11 Enhancement的选项，勾选它
### 7. 在resources文件夹下新建ebean.properties，添加配置
```
...
```
### 10. kotlin使用Ebean，这里不写services了，直接写一个controller
```
...
```
### 11. java使用Ebean，这里不写services了，直接写一个controller
```
@GetMapping("/test2")
public String test2() {
